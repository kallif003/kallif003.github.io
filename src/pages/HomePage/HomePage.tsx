			...
			<ContainerCards
				...
				<Cards>
					...
					<Body1 className="mt-2">
						Sou certificado pelo escola Coder no curso de desenvolvido web
						completo onde pude aprender muito sobre essa linguagem e
						aperfeiçoar-me na utilização dessa tecnologia
					</Body1>
				</Cards>
				<Cards>
					<Logo
					...
					<Body1 className="mt-2">
						Na hora de codar essas duas frameworks são incriveis e gosto muito
						de utiliza e aprender mais sobre elas
					</Body1>
				</Cards>
				<Cards>
					<Logo
					...
					<Body1 className="mt-2">
						Na hora de densenvolver aplicações mobile nada melhor que essa
						framework que tenho muito gosto em utilizar
					</Body1>
				</Cards>
			</ContainerCards>
